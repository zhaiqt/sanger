...
parser.add_argument("-s","--species",default='mouse',help='Enter the species you are interested. Example: human, mouse, rabbit. Default: human')
...
os.system("/home/zhaiqi1/NGS/IgBlast/1.4.0/ncbi-igblast-1.4.0/bin/igblastp -germline_db_V /home/zhaiqi1/NGS/IgBlast/database/%s_gl_V  -domain_system imgt -num_alignments_V 1 -query %s -organism %s > %s.igblastp" %(species,inputname,species,inputname.rstrip('.txt')))
print "IgBlastp has been performed. the results are in %s.igblastp" % inputname.rstrip(".txt")
